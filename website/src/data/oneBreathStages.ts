...
export const ONE_BREATH_STAGES: readonly Stage[] = [
  ...
  oneBreath(
    'one-breath-fingerprints', 'Fingerprints',
  ...
  oneBreath(
    'one-breath-chooser', 'The chooser',
  ...
  oneBreath(
    'one-breath-foundation', 'Foundation',
    'Built on UC Davis.',
  ...
  oneBreath(
    'one-breath-silent', 'Silent speech',
    'For silent speech.',
